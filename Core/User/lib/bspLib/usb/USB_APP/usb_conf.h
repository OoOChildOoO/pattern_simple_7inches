...
#define USBLED1			0x0100					// PH 8
#define WUSBLED1		!(GPIOH->ODR&USBLED1)	// PH 8
#define SETUSBLED1()	GPIOH->BSRRH = USBLED1	// PH 8		=0
#define CLRUSBLED1()	GPIOH->BSRRL = USBLED1	// PH 8		=1
