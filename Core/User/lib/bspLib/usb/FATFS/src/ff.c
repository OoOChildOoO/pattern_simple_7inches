...
//------------------------------------------
// Function   : chk_chr()				
// Description: Check if chr is contained in the string					
//------------------------------------------
...
//------------------------------------------
// Function   : lock_fs()				
// Description: Request grant to access the volume
...
//------------------------------------------
// Function   : unlock_fs()				
// Description: Release grant to access the volume
// FATFS *fs,	File system object
...
//------------------------------------------
// Function   : chk_lock()				
// Description: Check if the file can be accessed
// DIR* dj,		Directory object pointing the file to be checked 
// int acc		Desired access (0:Read, 1:Write, 2:Delete/Rename)					
//------------------------------------------
static
FRESULT chk_lock (DIR* dj,int acc)
{
	UINT i, be;
...
//------------------------------------------
// Function   : enq_lock()				
// Description: Check if an entry is available for a new file					
//------------------------------------------
...
//------------------------------------------
// Function   : inc_lock()				
// Description: Increment file open counter and returns its index (0:int error)
// DIR* dj,		Directory object pointing the file to register or increment
// int acc		Desired access mode (0:Read, !0:Write)					
//------------------------------------------
static
UINT inc_lock (DIR* dj,int acc)
{
	UINT i;
...
//------------------------------------------
// Function   : dec_lock()				
// Description: Decrement file open counter
...
//------------------------------------------
// Function   : clear_lock()				
// Description: Clear lock entries of the volume					
//------------------------------------------
static
...
// Description: Move to zero only writes back dirty window
// FATFS *fs,	File system object
...
//------------------------------------------
// Function   : sync()				
// Description: Clean-up cached data
// FATFS *fs	File system object					
//------------------------------------------
...
//------------------------------------------
// Function   : clust2sect()				
// Description: Get sector# from cluster#
// FATFS *fs,	File system object
...
//------------------------------------------
// Function   : get_fat()				
// Description: FAT access - Read value of a FAT entry
...
//------------------------------------------
// Function   : put_fat()				
// Description: FAT access - Change value of a FAT entry
// FATFS *fs,	File system object
...
// Description: FAT handling - Remove a cluster chain
// FATFS *fs,	File system object
...
// Description: FAT handling - Stretch or Create a cluster chain
...
//------------------------------------------
// Function   : clmt_clust()				
// Description: FAT handling - Convert offset into cluster with link map table
...
//------------------------------------------
// Function   : dir_sdi()				
// Description: Directory handling - Set directory index
...
//------------------------------------------
// Function   : dir_next()				
// Description: Directory handling - Move directory index next
...
//------------------------------------------
// Function   : cmp_lfn()				
// Description: LFN handling - Test/Pick/Fit an LFN segment from/to directory entry
...
// Description: Create numbered name
...
//------------------------------------------
// Function   : sum_sfn()				
// Description: Calculate sum of an SFN 					
//------------------------------------------
...
//------------------------------------------
// Function   : dir_find()				
// Description: Directory handling - Find an object in the directory
...
//------------------------------------------
// Function   : dir_read()				
// Description: Read an object from the directory					
//------------------------------------------
...
// Description: Register an object to the directory
...
//------------------------------------------
// Function   : dir_remove()				
// Description: Remove an object from the directory
// FR_OK: Successful, FR_DISK_ERR: A disk error 
// DIR *dj		Directory object pointing the entry to be removed					
//------------------------------------------
static
FRESULT dir_remove (DIR *dj)
{
	FRESULT res;
#if _USE_LFN	// LFN configuration //
	WORD i;
...
// Description: Pick a segment and create the object name in directory form
...
// Description: Get file information from directory entry
// DIR *dj,		Pointer to the directory object
...
// Description: Follow a file path
...
//------------------------------------------
// Function   : check_fs()				
// Description: Load a sector and check if it is an FAT Volume Boot Record
...
// Description: Check if the file system object is valid or not
...
//------------------------------------------
// Function   : f_chdrive()				
// Description: Current Drive/Directory Handlings
...
//------------------------------------------
// Function   : f_readdir()				
// Description: Read Directory Entry in Sequense
...
//------------------------------------------
// Function   : f_forward()				
// Description: Forward data to the stream directly (available on only tiny cfg)
// FIL *fp, 						Pointer to the file object 
...
//------------------------------------------
// Function   : f_mkfs()				
// Description: Create File System on the Drive	
...
//------------------------------------------
// Function   : f_fdisk()				
// Description: Divide Physical Drive
